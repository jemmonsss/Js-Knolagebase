...
The built-in split-pane Markdown editor at `/editor/` provides a fast way to create new wiki pages from templates without manually creating files.
...
Visit `/editor/` on your site. You will see a toolbar, a Markdown editor on the left, and a live preview on the right.
...
- Learn about front matter in [Adding Content](/wiki/using-this-wiki/adding-content/).
