...
- Add your first page following the guide in [Adding Content](/wiki/using-this-wiki/adding-content/).
- Change the site title, colors, and navigation in [Editing Settings](/wiki/using-this-wiki/editing-settings/).
